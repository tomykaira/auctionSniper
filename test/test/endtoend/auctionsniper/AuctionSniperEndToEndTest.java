...
public class AuctionSniperEndToEndTest {
	...
	public void sniperJoinsAuctionUntilAuctionCloses() throws Exception {
		...
		application.showsSniperHasLostAcution(0, 0);
	}
	...
	public void sniperMakesAHigherBidButLoses() throws Exception {
		...
		auction.announceClosed();
		application.showsSniperHasLostAcution(1000, 1098);
	}
	...
	public void sniperBidsForMultipleItems() throws Exception {
		...
		auction.reportPrice(1098, 97, ApplicationRunner.SNIPER_XMPP_ID);
		auction2.reportPrice(521, 32, ApplicationRunner.SNIPER_XMPP_ID);
	...
	public void sniperLosesAnAuctionWhenThePriceIsTooHigh() throws Exception {
		...
		auction.announceClosed();
		application.showsSniperHasLostAcution(1207, 1098);
	}
